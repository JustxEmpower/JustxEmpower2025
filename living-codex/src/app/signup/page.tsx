    ...
    <div className="min-h-screen bg-codex-deep flex items-center justify-center px-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-12 animate-fade-in">
          ...
          <h1 className="font-cormorant text-4xl text-codex-gold mb-2">Begin Your Journey</h1>
        ...
        <form onSubmit={handleSubmit} className="codex-card animate-fade-up">
          ...
          <div className="mb-6">
            <label className="block text-xs tracking-widest uppercase text-codex-cream/30 mb-2">Your Name</label>
            <input
              type="text"
              value={name}
          ...
          <div className="text-center mt-6">
            <a href="/login" className="text-sm text-codex-cream/30 hover:text-codex-gold/60 transition-colors">
