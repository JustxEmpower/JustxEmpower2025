        ...
        <div className="sticky top-0 z-10 bg-[#FAF7F4]/80 backdrop-blur-lg border-b border-[#D4C4BC]">
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              <div><h1 className="text-2xl font-bold text-[#2D2420]">Forms</h1><p className="text-[#8A7E76] text-sm">Manage custom forms and submissions</p></div>
              <div className="flex items-center gap-3">
                <Button variant="outline" size="sm" onClick={() => formsQuery.refetch?.()}><RefreshCw className="w-4 h-4 mr-2" />Refresh</Button>
                <Button className="bg-[#5C3D4E] hover:bg-[#6E4D5E] text-white"><Plus className="w-4 h-4 mr-2" />New Form</Button>
              </div>
            </div>
          </div>
        </div>
