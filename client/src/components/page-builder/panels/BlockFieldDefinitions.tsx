...
export const JE_BLOCK_FIELDS: Record<string, FieldDefinition[]> = {
  ...
  'je-paragraph': [
    ...
    { key: 'maxWidth', label: 'Max Width', type: 'select', options: [
      { value: 'xs', label: 'Extra Narrow (320px)' },
      { value: 'sm', label: 'Small (384px)' },
      { value: 'md', label: 'Medium (448px)' },
      { value: 'lg', label: 'Large (512px)' },
      { value: 'xl', label: 'Extra Large (576px)' },
      { value: '2xl', label: '2XL (672px)' },
      { value: '3xl', label: '3XL (768px)' },
